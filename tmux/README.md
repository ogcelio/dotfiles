...
This guide summarizes the specific configuration and keybindings defined in your `.tmux.conf`.
...
*   **Copy Text:** Press `y` or `Enter`. It will automatically copy to your system clipboard (using `pbcopy` on macOS or OSC 52 on Linux).
...
*   **Restore:** When you start tmux, it will automatically try to restore your previous environment.
